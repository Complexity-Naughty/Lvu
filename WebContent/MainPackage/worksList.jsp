...
<body>
	...
	<div id="cutline">
		...
		<div id="search">
			<form action="worksList">
				<input id="key" name="key" placeholder="请输入查找内容">
	...
	<div id="works">
		...
		<div id="works_inf">
			<div id="works_title"> <a href="#">【标题】</a> </div>
			<div id="works_summary">梗概</div>
			<div id="works_tips">
				<dir id="works_author">作者：</dir>
				<div id="works_time">时间：</div>
			</div>
		</div>
	</div>
	<!-- 作品展示 -->
	<s:action name="worksList" executeResult="true" namespace="/MainPackage" />
		...
		<div id="works">
			...
			<!-- 发现在img标签里指定height ，他就会自动缩放  适应父div， 以后长个脑子吧-->
				...
				<div id="works_inf">
					...
					<div id="works_tips">
						<dir id="works_author">作者：${works.authorName}</dir>
	...
	<div id="pageCount">
		<div id="pageBtn"><a href="?pageNum=1">首页</a></div>
		<div id="pageBtn"><a href="?pageNum=${pageNo>1 ? pageNo-1 : 1}">上一页</a></div>
		<div id="pageBtn"><a href="?pageNum=${pageNo<pageCount ? pageNo+1 : pageCount }">下一页</a></div>
		<div id="pageBtn"><a href="?pageNum=${pageCount }">末页</a></div>
	</div>
